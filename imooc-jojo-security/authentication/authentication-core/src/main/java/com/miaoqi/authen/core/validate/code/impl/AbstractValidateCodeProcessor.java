 ...
 *
 */
package com.miaoqi.authen.core.validate.code.impl;

import com.miaoqi.authen.core.validate.code.ValidateCode;
import com.miaoqi.authen.core.validate.code.ValidateCodeException;
import com.miaoqi.authen.core.validate.code.ValidateCodeGenerator;
import com.miaoqi.authen.core.validate.code.ValidateCodeProcessor;
import com.miaoqi.authen.core.validate.code.ValidateCodeType;
...
public abstract class AbstractValidateCodeProcessor<C extends ValidateCode> implements ValidateCodeProcessor {
    ...
    private void save(ServletWebRequest request, C validateCode) {
        this.sessionStrategy.setAttribute(request, this.getSessionKey(request), validateCode);
    }
    ...
    private String getSessionKey(ServletWebRequest request) {
        return ValidateCodeProcessor.SESSION_KEY_PREFIX + this.getValidateCodeType(request).toString().toUpperCase();
    }
    ...
    public void validate(ServletWebRequest request) {
        ...
        C codeInSession = (C) this.sessionStrategy.getAttribute(request, sessionKey);
